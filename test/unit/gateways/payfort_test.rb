...
class PayfortTest < Test::Unit::TestCase
  def setup
    @gateway = PayfortGateway.new(merchant_identifier: 'lBmxhStQ', access_code: 'B7a8a41jtuK8YBi3dSnA')
  ...
  def successful_purchase_response
    %(
      ...
      $ DEBUG_ACTIVE_MERCHANT=true ruby -Itest \
        test/remote/gateways/remote_payfort_test.rb \
