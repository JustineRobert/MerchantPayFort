...
class RemotePayfortTest < Test::Unit::TestCase
  def setup
    @gateway = PayfortGateway.new(fixtures(:payfort))
  ...
  def test_successful_store
    response = @gateway.store(@credit_card, {remember_me: true, return_url: 'http://api.lavo.devlits.com/'})
  ...
  def test_invalid_login
    gateway = PayfortGateway.new(login: '', password: '')
